...
int atomic_hash_add (hash_t *h, void *key, size_t len, void *data, int ttl, void *dtor_arg);
int atomic_hash_del (hash_t *h, void *key, size_t len, void *dtor_arg);
int atomic_hash_get (hash_t *h, void *key, size_t len, void *dtor_arg);
void atomic_hash_stats (hash_t *h, unsigned int time);
#endif
